...
def button(massage,x,y,w,h,inicolor,actcolor):
		...
		textSurf1,textRect1 = text_objects(massage,smallText)
...
def game_intro():
	...
	while intro:
		...
		button("Start!",150,450,100,50,light_green,green)
		button("Quit",550,450,100,50,pink,red)
